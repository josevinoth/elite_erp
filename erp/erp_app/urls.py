...
urlpatterns = [
    ...
    path(
        ...
        list_layout_drawing_approvals_api_view,
        name="api-project-layout-drawing-approvals",
    ),
    ...
    path(
        ...
        download_costing_items_import_template_api_view,
        name="api-project-costing-items-import-template",
    ),
    path(
        "api/project-costing/<int:pk>/items/import/",
        import_costing_items_excel_api_view,
        name="api-project-costing-items-import",
    ),
    path(
        "api/project-costing/<int:costing_pk>/items/<int:item_pk>/",
        project_costing_item_detail_api_view,
        name="api-project-costing-item-detail",
    ),
    ...
    path(
        ...
        name="api-project-layout-drawings-list",
    ),
    path(
        "api/projects/<int:project_id>/layout-drawings/save/",
        save_project_layout_drawings_api_view,
        name="api-project-layout-drawings-save",
    ),
    path(
        "api/projects/status-options/add/",
        create_project_lifecycle_status_option_api_view,
        name="api-projects-status-add",
    ),
    # stock purchase
    ...
    path(
        ...
        stock_purchase_item_trace_api_view,
        name="api-stock-purchase-item-trace",
    ),
    path(
        "api/stock-purchase-vendors/create/",
        create_stock_purchase_vendor_detail_api_view,
        name="api-stock-purchase-vendors-create",
    ),
    path(
        "api/stock-purchase-vendors/<int:pk>/",
        stock_purchase_vendor_detail_api_view,
        name="api-stock-purchase-vendors-detail",
    ),
    path(
        "api/stock-purchase/status-options/",
        list_stock_purchase_status_options_api_view,
        name="list_stock_purchase_status_options_api_view",
    ),
    path("api/stock-purchase/place-order/meta/", place_stock_order_meta_api_view, name="api-stock-purchase-place-order-meta"),
    path("api/stock-purchase/place-order/", place_stock_order_api_view, name="api-stock-purchase-place-order"),
    # stock maintenance
    ...
    path(
        ...
        create_stock_maintenance_type_option_api_view,
        name="api-stock-maintenance-type-add",
    ),
    # tasks
    ...
    path("api/cdc-team-expence/import/", import_cdc_team_expenses_excel_api_view, name="api-cdc-team-expence-import"),
    path(
        "api/cdc-team-expence/template/",
        download_cdc_team_expense_template_api_view,
        name="api-cdc-team-expence-template",
    ),
    path(
        "api/cdc-team-expence/bulk-update/",
        cdc_team_expense_bulk_update_api_view,
        name="api-cdc-team-expence-bulk-update",
    ),
    ...
    path(
        ...
        create_expense_item_option_api_view,
        name="api-cdc-team-expence-item-add",
    ),
    path(
        "api/cdc-team-expence/status-options/add/",
        create_expense_status_option_api_view,
        name="api-cdc-team-expence-status-add",
    ),
    path(
        "api/cdc-team-expence/session-options/add/",
        create_expense_session_option_api_view,
        name="api-cdc-team-expence-session-add",
    ),
    # comments
    ...
    path(
        "api/comment-attachments/<int:pk>/download/",
        download_comment_attachment_api_view,
        name="api-comment-attachments-download",
    ),
    path(
        "api/comment-attachments/<int:pk>/view/",
        view_comment_attachment_api_view,
        name="api-comment-attachments-view",
    ),
    path(
        "api/comment-attachments/<int:pk>/",
        delete_comment_attachment_api_view,
        name="api-comment-attachments-delete",
    ),
    ...
    path(
        ...
        list_unread_task_notifications_api_view,
        name="api-notifications-tasks-unread",
    ),
    path(
        "api/notifications/messages/unread/",
        list_unread_message_notifications_api_view,
        name="api-notifications-messages-unread",
    ),
    path(
        "api/notifications/tasks/mark-read/",
        mark_task_notifications_read_api_view,
        name="api-notifications-tasks-mark-read",
    ),
    path(
        "api/notifications/messages/mark-read/",
        mark_message_notifications_read_api_view,
        name="api-notifications-messages-mark-read",
    ),
    # LCE costing
    ...
    path(
        ...
        list_lce_cost_details_by_project_api_view,
        name="api-lce-costing-by-project",
    ),
    path(
        "api/lce-costing/cost-index/calculate/",
        calculate_lce_cost_index_api_view,
        name="api-lce-costing-cost-index-calculate",
    ),
    ...
    path(
        ...
        create_lce_charge_type_option_api_view,
        name="api-lce-estimates-charge-types-add",
    ),
    ...
    path(
        ...
        lce_estimate_record_api_view,
        name="api-lce-estimates-record",
    ),
    path(
        "api/lce-estimates/purchase-items/<int:purchase_id>/",
        lce_purchase_items_api_view,
        name="api-lce-purchase-items",
    ),
    # lab furniture items
    ...
    path(
        ...
        list_lab_furniture_item_categories_api_view,
        name="api-lab-furniture-item-categories-list",
    ),
    path(
        "api/lab-furniture-item-categories/create/",
        create_lab_furniture_item_category_api_view,
        name="api-lab-furniture-item-categories-create",
    ),
    ...
    # item types
    path("api/item-types/", list_item_types_api_view, name="api-list-item-types"),
    # stock manufacture
    ...
    path(
        "api/projects/<int:project_id>/layout-drawings/",
        list_project_layout_drawings,
        name="list_project_layout_drawings",
    ),
    path(
        "api/projects/<int:project_id>/layout-drawings/upload/",
        upload_project_layout_drawing,
        name="upload_project_layout_drawing",
    ),
]
