# Function Mapping - StockItemsPage

| Layer | Functions/Components | Linked Files/Modules |
|---|---|---|
| Page | StockItemsPage | `frontend/src/pages/StockItemsPage.jsx` |
| Functions / Views | `list_lab_furniture_items_api_view`, `list_lab_furniture_item_categories_api_view`, `create_lab_furniture_item_category_api_view`, `create_lab_furniture_item_api_view`, `lab_furniture_item_detail_api_view` | `frontend/src/pages/StockItemsPage.jsx` |
