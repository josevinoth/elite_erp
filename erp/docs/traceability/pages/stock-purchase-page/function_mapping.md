# Function Mapping - StockPurchasePage

| Layer | Functions/Components | Linked Files/Modules |
|---|---|---|
| Page | StockPurchasePage | `frontend/src/pages/StockPurchasePage.jsx` |
| Functions / Views | `list_stock_purchases_api_view`, `create_stock_purchase_api_view`, `stock_purchase_detail_api_view`, `stock_purchase_item_trace_api_view`, `list_stock_purchase_status_options_api_view` | `frontend/src/pages/StockPurchasePage.jsx` |
