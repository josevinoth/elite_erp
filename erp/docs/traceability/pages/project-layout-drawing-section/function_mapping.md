# Function Mapping - ProjectLayoutDrawingSection

| Layer | Functions/Components | Linked Files/Modules |
|---|---|---|
| Page | ProjectLayoutDrawingSection | `frontend/src/pages/ProjectLayoutDrawingSection.jsx` |
| Functions / Views | `list_layout_drawing_approvals_api_view`, `list_project_layout_drawings_api_view`, `save_project_layout_drawings_api_view`, `project_layout_drawing_view` | `frontend/src/pages/ProjectLayoutDrawingSection.jsx` |
