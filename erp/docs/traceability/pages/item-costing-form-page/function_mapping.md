# Function Mapping - ItemCostingFormPage

| Layer | Functions/Components | Linked Files/Modules |
|---|---|---|
| Page | ItemCostingFormPage | `frontend/src/pages/ItemCostingFormPage.jsx` |
| Functions / Views | `list_item_costing_api_view`, `item_costing_meta_api_view`, `item_costing_cost_preview_api_view`, `create_item_costing_api_view`, `item_costing_detail_api_view` | `frontend/src/pages/ItemCostingFormPage.jsx` |
