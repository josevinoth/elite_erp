# Function Mapping - CutOptimiserListPage

| Layer | Functions/Components | Linked Files/Modules |
|---|---|---|
| Page | CutOptimiserListPage | `frontend/src/pages/CutOptimiserListPage.jsx` |
| Functions / Views | `list_cut_optimiser`, `create_cut_optimiser`, `cut_optimiser_detail`, `list_cut_sizes`, `cut_size_detail` | `frontend/src/pages/CutOptimiserListPage.jsx` |
