# Function Mapping - user_management_api

| Layer | Functions/Components | Linked Files/Modules |
|---|---|---|
| Module | user_management_api | `erp_app/sub_views/user_management_api.py` |
| Functions / Views | `csrf_token_view`, `register_meta_api_view`, `register_api_view`, `login_api_view`, `logout_api_view`, `forgot_password_api_view`, `reset_password_api_view`, `list_users_api_view`, `list_pending_registrations_api_view`, `approve_registration_api_view`, `user_detail_api_view` | `erp_app/sub_views/user_management_api.py` |
