# Function Mapping - stock_purchase_status_option_api

| Layer | Functions/Components | Linked Files/Modules |
|---|---|---|
| Module | stock_purchase_status_option_api | `erp_app/sub_views/stock_purchase_status_option_api.py` |
| Functions / Views | `list_stock_purchases_api_view`, `create_stock_purchase_api_view`, `stock_purchase_detail_api_view`, `stock_purchase_item_trace_api_view`, `list_stock_purchase_status_options_api_view` | `erp_app/sub_views/stock_purchase_status_option_api.py` |
