# Requirements - stock_purchase_status_option_api

## Module purpose and business requirement
List active stock purchase status options.

Source file: `erp_app/sub_views/stock_purchase_status_option_api.py`
