# Function Mapping - task_meta_api

| Layer | Functions/Components | Linked Files/Modules |
|---|---|---|
| Module | task_meta_api | `erp_app/sub_views/task_meta_api.py` |
| Functions / Views | `list_tasks_api_view`, `list_task_meta_api_view`, `create_task_api_view`, `task_detail_api_view`, `import_tasks_excel_api_view`, `download_task_template_api_view`, `create_task_status_option_api_view`, `create_activity_option_api_view`, `create_project_status_option_api_view` | `erp_app/sub_views/task_meta_api.py` |
