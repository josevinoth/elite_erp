# Function Mapping - item_costing_api

| Layer | Functions/Components | Linked Files/Modules |
|---|---|---|
| Module | item_costing_api | `erp_app/sub_views/item_costing_api.py` |
| Functions / Views | `list_item_costing_api_view`, `item_costing_meta_api_view`, `item_costing_cost_preview_api_view`, `create_item_costing_api_view`, `item_costing_detail_api_view` | `erp_app/sub_views/item_costing_api.py` |
